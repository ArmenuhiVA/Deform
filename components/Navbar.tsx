  ...
  return (
    <Disclosure as="nav" className="bg-white-800" >
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex  items-center justify-between mt-8 border-b h-16">
          ...
          <div className="flex flex-1 items-end justify-end sm:items-stretch sm:justify-start">
