    ...
    <Layout>
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 h-56 my-16 ">
        <div className="text-lg lg:text-xl leading-relaxed lg:flex lg:space-x-12">
          <h2 className="lg:w-1/2 heading-2">About</h2>
          <div className="lg:w-1/2">
            <h2 className=" subheading-1">Welcome to Deform, where your story becomes our inspiration.</h2>
            <p className="w-auto my-4 paragraph-l">For us, design isn't just a job — it's a calling to make a difference in people's lives.
            ...
            <div className="w-40 h-10 border-zinc-500 border-b-solid border-b-2 ml-auto">
              <a href="/about">
                <Image src={arrowright} alt="Logo" className="object-contain ml-auto" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="text-lg lg:text-xl leading-relaxed lg:flex lg:space-x-12">
          <div className="w-full sm:w-1/2 lg:w-1/3 border-zinc-500 border-solid border-2 h-96 mb-2 lg:mb-0 lg:mr-4">

          </div>
          <div className="w-full sm:w-1/2  lg:w-1/3 border-zinc-500 border-solid border-2 h-96 mb-2 lg:mb-0 lg:mr-4">

          </div>
          <div className="w-full lg:w-1/3 border-zinc-500 border-solid border-2 h-96 hidden lg:block">
        ...
        <div className="leading-relaxed lg:flex lg:space-x-12">
          <div className="lg:w-[610px]">
            ...
            <div className="border-zinc-500 border-b-solid border-b-2 mt-10 pb-4 flex items-center justify-between text-customGray">
              ...
              <a href="/about">
                <Image src={arrowright} alt="Arrow" className="object-contain ml-auto text-customGray" />
              </a>
            </div>
            ...
            <div className="w-40 h-10 border-zinc-500 border-b-solid border-b-2 mt-16 ">
              <a href="/about">
                <Image src={arrowright} alt="Arrow" className="object-contain ml-auto " />
              </a>
            </div>
          </div>
          <div className="lg:w-[610px]">
            <Image src={kitchenimg} alt="Kitchen" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
